var JACSANYDATE = new function()
    {// This date is used throughout to determine today's date.
     ...
     document.writeln(
        '<style type="text/css">' +
            '/* IMPORTANT:  The JACSANYDATE calendar script requires all ' +
        ...
        {switch (cal.id)
            {case 'EnterYourIDHere':
             ...
             default:
                ...
                cal.baseYear = dateNow.getFullYear()-80;

                cal.dropDownYears = 90;
             ...
             function setOutput(outputDate,calId)
                {var cal = getEl(calId);
                 ...
                 if (cal.dynamic) {hide(calId);}
                       ...
                       JACSANYDATE.show(cal.ele,cal.id,cal.days);
                      }
                            ...
                            {rows.childNodes[j].innerHTML = showDate.getDate();
                             ...
                             if ((cal.outOfRangeDisable && (showDate < (new Date(cal.baseYear,0,1,12)) ||
                                ...
                                {if ((cal.days.join().search(((j-1+(7*(i*cells.length/6))+cal.weekStart)%7))>-1) ||
                                    ...
                                    )   {disabled = !cal.valuesEnabled;} // Set (Disable or Enable) if the day is passed as a parameter of JACSANYDATE.show
     ...
     return {show: function(ele)
                {
                 ...
                 if (!getEl(calId)) {JACSANYDATE.make(calId,dynamic);}
                ...
                {if (typeof arguments[0]=='string')
                 ...
                 if (getEl(calID))
                    ...
                    {alert('ERROR: Calendar object <<' + calID + '>> does not exist.\n' +
                           ...
                           'and that JACSANYDATE.show is called before JACSANYDATE.next.');
                    }
                }
            };
    };
